...
### 03
As a driver
I want the pricing service to calculate the total parking cost accurately based on the entry and exit times,
factoring in any partial hours or maximum daily price
...
### 04 My thoughts:
	...
	- i need reservation 
		- entryAt 
		- exitAt 
		- calculate total Hours ( include round UP partail hours) -> identify the plan
		- Total Price
	...
	- PriceCalculator
		- calculate the reservation total
			- Identify appropraite plans
			- check for the MaxDialy Price if (IsDaily)
		- factoring the Driver
